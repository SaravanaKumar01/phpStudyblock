				...
				<div class="login-box">
					...
					<form class="form-horizontal" action="login.php" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="password" id="username" type="Password" placeholder="Password"/>
							</div>
							<div class="clearfix"></div>
							...
							<div class="button-login">	
								...
								<button  class="btn btn-warning"><a class="collapse-item" href="stinfo.php">Register</a></button>
							</div>
							<div class="clearfix"></div>
					</form>
					<hr>	
